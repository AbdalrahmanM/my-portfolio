...
export const Main = () => {
  return (
    <div
      id="home"
      className="w-full h-screen text-center max-sm:pt-24 section-slide-in"
    >
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          ...
          <h1 className="py-4 text-gray-700">
            Hi, I&apos;m <span className="text-[#5651e5]">ABDULRAHMAN</span>
          </h1>
          <h1 className="py-4 text-gray-700">A Front-End Web Developer</h1>
          <p className="py-4 text-gray-600 max-w-[70%] m-auto">
            with a passion for creating immersive digital experiences that
            seamlessly blend innovative design and flawless functionality. My
            expertise lies in responsive web development, and I&apos;m excited
            to contribute to dynamic projects that leave a lasting impact on
            user engagement.
          </p>
