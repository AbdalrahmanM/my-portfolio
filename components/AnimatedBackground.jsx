...
const AnimatedBackground = () => {
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden bg-[#09090b]">
      <div className="absolute inset-0 bg-[linear-gradient(135deg,#09090b_0%,#111114_48%,#09090b_100%)]" />
      <motion.div
        className="absolute -left-[35%] top-[12%] h-32 w-[110%] -rotate-12 bg-gradient-to-r from-transparent via-blue-600/10 to-transparent blur-2xl"
